...
"""
"""I used AI to help me understand inheritance, method overriding, and how to structure my classes. 
I wrote the final code myself and made sure I fully understood how each method works."""
import random
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        if roll <= 3:
            ...
            damage = base_damage
            print(f"{self.name} strikes swiftly at {target.name} for {damage} damage!")
        target.take_damage(damage)
